# *******************************************************************
# Requires Library pygame - tested on LINUX OS Ubuntu 22.04
# *******************************************************************
...
fps = 10 # keep a low frame rate (dont need high for turn base) anything above 10 causes preformance issues especially on quit
cellsize = 100
