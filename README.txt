...
TEST INSTRUCTIONS:
   ...
   repeatedly click the pygame interface window to watch the
   pieces simulate movement in a turn pace game

   CTRL+C in the console to quit or use the 'x' button on the window to quit

NOTE: in main.py keep the fps constant set to 10 or lower or will cause performance issues especially on exit events
